...
--max-memory-data-size 10000000000 --number-walks 80 --representation-size 128 --walk-length 40 --window-size 10 \
--workers 80 --output road_graph/roadnet.embeddings --undirected ""